                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={ev => this.Save(ev)}>
                                    ...
                                    ISBN
                                    <input type="text" disabled className="form-control mb-2"
                                    ...
                                    <button className="btn btn-info btn-block m-1" type="submit">
                                        Simpan
                                    </button>
                                    <button className="btn btn-danger btn-block m-1" onClick={()=>this.close()}>
                                        Batal
                                    </button>
                                </form>
                            </div>
